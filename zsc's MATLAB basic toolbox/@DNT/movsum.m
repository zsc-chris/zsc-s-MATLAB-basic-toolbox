...
%MOVSUM	Moving sum value for DNT data
%	ret=MOVSUM(self,k,dims=self.dimnames,nanflag="includemissing",*,
...
%
%	Example:
%	>> MOVSUM(DNT([1,2,3;4,5,6;7,8,nan],["a","b"]),{1,1},["a","b"],"omitmissing",SamplePoints={[1,1.5,2],1:3})
%
%	ans =
%
...
%	Copyright 2025 Chris H. Zhao
	...
	dstar=dstarclass;
	ret=movfun(@sum,self,k,dims,dstar{options},AdditionalInput={nanflag});
end