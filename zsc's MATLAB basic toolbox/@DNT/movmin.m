...
%MOVMIN	Moving maximum value for DNT data
%	ret=MOVMIN(self,k,dims=self.dimnames,nanflag="includemissing",*,
...
%
%	Example:
%	>> MOVMIN(DNT([1,2,3;4,5,6;7,8,nan],["a","b"]),{1,1},["a","b"],"omitmissing",SamplePoints={[1,1.5,2],1:3})
%
%	ans =
%
