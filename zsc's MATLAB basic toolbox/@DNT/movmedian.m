...
%MOVMEDIAN	Moving median value for DNT data
%	ret=MOVMEDIAN(self,k,dims=self.dimnames,nanflag="includemissing",*,
...
%
%	Example:
%	>> MOVMEDIAN(DNT([1,2,3;4,5,6;7,8,nan],["a","b"]),{1,1},["a","b"],"omitmissing",SamplePoints={[1,1.5,2],1:3})
%
%	ans =
%
...
%
%	    1                   1         2         3
%	    2              2.5000    3.5000    4.5000
%	    3              5.5000    6.5000         6
%
%	See also movmedian, DNT
...
%	Copyright 2025 Chris H. Zhao
	...
	dstar=dstarclass;
	ret=movfun(@median,self,k,dims,dstar{options},AdditionalInput={nanflag});
end