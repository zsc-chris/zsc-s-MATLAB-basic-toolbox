...
%IFFT	Inverse discrete Fourier transform of dnm
%	ret=IFFT(self,n/(n,dims)/*n/**n/mapping(**n))
%
%	Note: To avoid ambiguity, n will not be broadcast if it is scalar.
%
%	Example:
%	>> IFFT(DNT([1,2;4,2;9,0],["a","b"]),a=2)
%
%	ans =
%
...
%	Copyright 2025 Chris H. Zhao
	...
	ret=fevalalong(@ifft_,zsc.cell2mat(n(1,:)),self,KeepDims=true,AdditionalInput={zsc.cell2mat(n(2,:))});
end
