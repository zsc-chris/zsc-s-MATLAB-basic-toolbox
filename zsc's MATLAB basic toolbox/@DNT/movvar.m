...
%MOVVAR	Moving standard deviation for DNT data
%	ret=MOVVAR(self,k,w=1,dims=self.dimnames,nanflag="includemissing",*,
...
%
%	Example:
%	>> MOVVAR(DNT([1,2,3;4,5,6;7,8,nan],["a","b"]),{1,1},1,["a","b"],"omitmissing",SamplePoints={[1,1.5,2],1:3})
%
%	ans =
%
...
%	Copyright 2025 Chris H. Zhao
	...
	dstar=dstarclass;
	ret=movfun(@(x,dims,nanflag)zsc.var(x,w,dims,nanflag),self,k,dims,dstar{options},AdditionalInput={nanflag});
end