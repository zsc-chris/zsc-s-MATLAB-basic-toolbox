...
%
%	Note: If the object being subsasgned does not exist, ret defaults to 2.
%		To change this behavior, subclass this class as a handle class and
%		use an attribute.
%
%	See also numArgumentsFromSubscript, dstarclass
